...
public class FrontControllerServletV5 extends HttpServlet {
    ...
    private final Map<String, Object> handlerMappingMap = new HashMap<>();   // 버전을 유연하게 쓰기 위해 Object
    ...
    private MyHandlerAdapter getHandlerAdapter(Object handler) {
        for (MyHandlerAdapter adapter : handlerAdapters) { // v3 돌았다가 아니면 false 하고 다시 한번 더 돔 for문이니까
